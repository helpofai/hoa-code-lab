      ...
      <main className="flex-1 flex items-center justify-center px-6 py-20 relative overflow-hidden">
        ...
        >
          <div className="glass-card p-8 rounded-2xl border border-white/20 dark:border-white/10 shadow-2xl">
            <h2 className="text-3xl font-black mb-8 text-center bg-clip-text text-transparent bg-gradient-to-r from-slate-900 to-slate-600 dark:from-white dark:to-slate-400">Welcome Back</h2>
            ...
            <div className="relative mb-8 text-center">
               ...
               <span className="relative bg-white/50 dark:bg-[#1e1e1e]/50 px-4 text-xs font-bold tracking-wider text-gray-500 uppercase backdrop-blur-sm">Or log in with email</span>
            </div>

            <form onSubmit={handleSubmit} className="space-y-5">
              <div>
                <label className="block text-sm font-semibold text-slate-700 dark:text-gray-300 mb-2">Email or Username</label>
                <input 
                  type="text" 
              ...
              <div>
                <div className="flex justify-between mb-2">
                   ...
                   <a href="#" className="text-xs font-medium text-green-600 dark:text-green-400 hover:text-green-500">Forgot Password?</a>
                </div>
                <input 
                  type="password" 
                  className="w-full bg-slate-50 dark:bg-black/50 border border-gray-200 dark:border-gray-700 rounded-lg px-4 py-3 text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-green-500/50 focus:border-green-500 transition-all placeholder-gray-400"
            ...
            <p className="mt-8 text-center text-sm text-slate-600 dark:text-gray-400">
               Need an account? <Link to="/signup" className="text-green-600 dark:text-green-400 font-bold hover:underline">Sign up now!</Link>
            </p>
          </div>
        </motion.div>
      </main>
